...
public class SupplierClient implements SupplierPortType {
    ...
    private String certificate = "A61_Supplier";

    private String keyName = "A61_Mediator";
	...
	public SupplierClient(String wsURL) throws SupplierClientException {
        ...
        manager.setKeystore(keyName + ".jks");
        manager.setKeyAlias(keyName.toLowerCase());
