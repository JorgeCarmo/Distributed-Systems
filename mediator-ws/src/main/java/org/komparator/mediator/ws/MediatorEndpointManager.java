...
public class MediatorEndpointManager {
    ...
    /**Secondary mediator service */
    MediatorService service = null;

    /** WS port (port type is the interface, port is the implementation) */
    MediatorPortType secondaryPort = null;
    ...
    /** Web Service location to publish */
	private final String SECONDWSURL = "http://localhost:8072/mediator-ws/endpoint";
    ...
    public void setAlive(Date date){
        this.alive = date;
    }
    ...
    public MediatorPortType getSecondPort(){
	...
	public void start() throws Exception {
        ...
        if(this.state == state.MAIN){
            ...
            service = new MediatorService();
         	secondaryPort = service.getMediatorPort();

            BindingProvider bindingProvider = (BindingProvider) secondaryPort;
            Map<String, Object> requestContext = bindingProvider.getRequestContext();
            requestContext.put(ENDPOINT_ADDRESS_PROPERTY, SECONDWSURL);
