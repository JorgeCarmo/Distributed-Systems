...
public class BuyCartIT extends BaseIT {
	...
	public void testEmptyCardId() throws EmptyCart_Exception, InvalidCartId_Exception, InvalidCreditCard_Exception,
		...
		mediatorClient.addToCart("xyz", id, 1, dateFormatter.format(new Date()));
		mediatorClient.buyCart("xyz", "", dateFormatter.format(new Date()));
	}
	...
	public void testIncompleteCard() throws EmptyCart_Exception, InvalidCartId_Exception,
		...
		id.setSupplierId(supplierNames[0]);
		mediatorClient.addToCart("xyz", id, 1, dateFormatter.format(new Date()));
		mediatorClient.buyCart("xyz", "8392320", dateFormatter.format(new Date()));
	}
	...
	public void testInvalidCard() throws EmptyCart_Exception, InvalidCartId_Exception, InvalidCreditCard_Exception,
		...
		id.setSupplierId(supplierNames[0]);
		mediatorClient.addToCart("xyz", id, 1, dateFormatter.format(new Date()));
		mediatorClient.buyCart("xyz", VALID_CC + "27282828022802", dateFormatter.format(new Date()));
	}
	...
	public void testInvalidCardLetters() throws EmptyCart_Exception, InvalidCartId_Exception,
		...
		id.setSupplierId(supplierNames[0]);
		mediatorClient.addToCart("xyz", id, 1, dateFormatter.format(new Date()));
		mediatorClient.buyCart("xyz", "12334567890aaabbb", dateFormatter.format(new Date()));
	}
	...
	public void testAnotherInvalidCard() throws EmptyCart_Exception, InvalidCartId_Exception,
		...
		id.setSupplierId(supplierNames[0]);
		mediatorClient.addToCart("xyz", id, 1, dateFormatter.format(new Date()));
		mediatorClient.buyCart("xyz", "1234567820123452", dateFormatter.format(new Date()));
	}
	...
	public void testFullBuy() throws EmptyCart_Exception, InvalidCartId_Exception, InvalidCreditCard_Exception,
		...
		// -- add products to carts --
		{
			...
			id.setProductId("p1");
			id.setSupplierId(supplierNames[0]);
			mediatorClient.addToCart("xyz", id, 2, dateFormatter.format(new Date()));
		}
...

		{
			...
			id.setProductId("p2");
			id.setSupplierId(supplierNames[0]);
			mediatorClient.addToCart("xyz", id, 3, dateFormatter.format(new Date()));
		}
		...
		{ // product in other cart! (will not try to buy this)
			...
			id.setProductId("p1");
			id.setSupplierId(supplierNames[1]);
			mediatorClient.addToCart("DoNotBuyMe", id, 1, dateFormatter.format(new Date()));
		}

		// -- buy a cart
		ShoppingResultView shpResView = mediatorClient.buyCart("xyz", VALID_CC, dateFormatter.format(new Date()));
	...
	public void testPartialBuy() throws EmptyCart_Exception, InvalidCartId_Exception, InvalidCreditCard_Exception,
		...
		// -- add products to carts --
		{
			...
			id.setProductId("p1");
			id.setSupplierId(supplierNames[0]);
			mediatorClient.addToCart("xyz", id, 4, dateFormatter.format(new Date()));
			mediatorClient.addToCart("otherXyz", id, 3, dateFormatter.format(new Date())); // Purchased
		}

		{
			...
			id.setProductId("p2");
			id.setSupplierId(supplierNames[0]);
			mediatorClient.addToCart("xyz", id, 15, dateFormatter.format(new Date()));
			mediatorClient.addToCart("otherXyz", id, 7, dateFormatter.format(new Date())); // Dropped
		}

		// -- buy carts
		ShoppingResultView[] shpResViews = new ShoppingResultView[2];
		shpResViews[0] = mediatorClient.buyCart("xyz", VALID_CC, dateFormatter.format(new Date()));
		shpResViews[1] = mediatorClient.buyCart("otherXyz", VALID_CC, dateFormatter.format(new Date()));
	...
	public void testEmptyBuy() throws EmptyCart_Exception, InvalidCartId_Exception, InvalidCreditCard_Exception,
		...
		// -- add products to carts --
		{
			...
			id.setProductId("p1");
			id.setSupplierId(supplierNames[0]);
			mediatorClient.addToCart("xyz", id, 10, dateFormatter.format(new Date()));
			mediatorClient.addToCart("otherXyz", id, 10, dateFormatter.format(new Date())); // Dropped
		}

		{
			...
			id.setSupplierId(supplierNames[0]);
			mediatorClient.addToCart("xyz", id, 15, dateFormatter.format(new Date()));
			mediatorClient.addToCart("otherXyz", id, 15, dateFormatter.format(new Date())); // Dropped
		}
